...
Official implementation of CVPR'26 paper: [*'Domain-Skewed Federated Learning with Feature Decoupling and Calibration'*](https://arxiv.org/pdf/2403.06495.pdf).
...
- **Digits**: include 4 domains (MNIST, USPS, SVHN, SYN) [[Google Drive]](https://drive.google.com/file/d/11kJ_xVB37J3_AXflccevnK-MJS8ETFcv/view?usp=sharing)
- **Office-Caltech**: include 4 domains (Caltech, Amazon, Webcam, DSLR) [[Google Drive]](https://drive.google.com/file/d/1xm-_gh60c8iacCqTIHH0-q7ZUEexZLBo/view?usp=sharing)
- **PACS**: include 4 domains (Photo, Art-Painting, Cartoon, Sketch) [[Google Drive]](https://drive.google.com/file/d/1t-z3Lglp1_aArBAhBp4xxKI6_NSwa2qr/view?usp=sharing)
...
## Citation
```
@inproceedings{WangF2DC_CVPR2026,
